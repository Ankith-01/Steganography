...
def text_steno():
    ...
    win = Toplevel(master=root, bg='#c3f0fa')
    win.title('Text')
    win.geometry('480x410')
    win.wm_iconbitmap('images/l2.ico')
    win_label = Label(win, text='Text', font=cas_big, bg='#c3f0fa', fg='#1046b3')
    ...
    def encode():
        ...
        size_label = Label(win, text='Select File:', font=cas, bg='#c3f0fa', fg='#f20713')
        ...
        ch_lb = Label(win, text='Select what you want to hide', bg='#c3f0fa', fg='#1046b3', font=cas)
        ch_lb.place(x=5, y=85)
        select = StringVar(win)
        style = ttk.Style(master=win)
        style.configure('C.TRadiobutton', font=cas, background='#c3f0fa', foreground='#1046b3')
        ...
        def choice():
            ...
            if select.get() == "1":
                ...
                lm = Label(message, text='Enter your message that you want to hide:', bg='blue', font=cas)
                ...
                bm = Button(message, text='Done', command=click, relief='flat', bg='yellow', font=cas)
        ...
        pass_label = Label(win, text='Set password:', font=cas, bg='#c3f0fa', fg='#1046b3')
        ...
        success = Label(win, bg='#c3f0fa', font=cas, fg='red')
        ...
        main = Button(win, text='Hide Data', command=execute, bg='#B2FF66', relief='ridge', font=cas)
        ...
        # refresh = Button(win, text='Refresh', command=refresh, state=DISABLED, relief='ridge', font=cas, bg='#99FFCC')
    ...
    def decode():
        ...
        global file_loc
        dec = Toplevel(master=root, bg='#c3f0fa')
        dec.title('Text DECODE')
        dec.geometry('480x250')
        dec.wm_iconbitmap('images/l2.ico')
        dec_label = Label(dec, text='Text [DECODE]', font=cas_big, bg='#c3f0fa', fg='#1046b3')
        dec_label.place(x=5, y=4)
        info_label = Label(dec, text='Select File:', font=cas, bg='#c3f0fa', fg='#f20713')
        ...
        pass_lb = Label(dec, text='Enter password:', bg='#c3f0fa', fg='#1046b3', font=cas)
    ...
    encoding = Button(win, text='Encode data', command=encode, relief='ridge', font=cas, bg='#B2FF66')
    encoding.place(x=40, y=360)
    ho.CreateToolTip(encoding, 'Encoding data function')
    decoding = Button(win, text="Decode data", command=decode, relief='ridge', font=cas, bg='#9999FF')
    decoding.place(x=180, y=360)
    ho.CreateToolTip(decoding, "Decoding data function")
    exit_win = Button(win, text='Exit', bg='#FF6666', font=cas, relief='ridge', command=win.destroy)
...
def image_steno():
    ...
    img_win.title('Image stegano')
    img_win.geometry('515x260')
    img_win.wm_iconbitmap('images/l2.ico')
    im_lb = Label(img_win, text='Image', bg='#c3f0fa', fg='#fa05bd', font=cas_big)
    ...
    def ex_img():
        ...
        ex_lb = Label(ex_win, text='Image[EXTRACT]', bg='#c3f0fa', fg='#fa05bd', font=cas_big)
        ...
        qu_bu = Button(ex_win, text='Exit', font=cas, bg='#f23f3f', fg='black', command=ex_win.destroy)
        qu_bu.place(x=467, y=278)
        ho.CreateToolTip(qu_bu, 'Exits window')

    bu_en = Button(img_win, text='Embed', font=cas, bg='#B2FF66', fg='black', command=em_img)
    bu_en.place(x=70, y=220)
    ho.CreateToolTip(bu_en, 'Embeds data in image file')
    bu_ex = Button(img_win, text='Extract', font=cas, bg='#9999FF', fg='black', command=ex_img)
    bu_ex.place(x=260, y=220)
    ho.CreateToolTip(bu_ex, 'Extracts data from image file')
    qubu = Button(img_win, text='Exit', font=cas, bg='#FF6666', fg='black', command=img_win.destroy)
...
def audio_steno():
    ...
    au_lb = Label(aud_win, text='Audio', bg='#c3f0fa', fg='#fa05bd', font=cas_big)
    ...
    bu_en = Button(aud_win, text='Embed', font=cas, bg='#B2FF66', fg='black', command=em_aud)
    bu_en.place(x=70, y=220)
    ho.CreateToolTip(bu_en, 'Embeds data in audio file')
    bu_ex = Button(aud_win, text='Extract', font=cas, bg='#9999FF', fg='black', command=ex_aud)
    bu_ex.place(x=230, y=220)
    ho.CreateToolTip(bu_ex, 'Extracts data from audio file')
    qubu = Button(aud_win, text='Exit', font=cas, bg='#FF6666', fg='black', command=aud_win.destroy)
    qubu.place(x=410, y=220)
    ho.CreateToolTip(qubu, 'Exits window')
...
lb = Label(root, text="Steganography", font=('Arial Black', 20), bg='#f5f59a', fg='#FF9933')
lb.place(x=18, y=20)
